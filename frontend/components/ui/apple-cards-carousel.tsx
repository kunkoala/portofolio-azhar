      ...
      >
        ...
        <div className="relative z-40 p-8">
          <motion.p
            ...
            className="text-white text-sm md:text-base font-medium text-left group-hover:text-blue-200 transition"
          >
            {card.category}
          </motion.p>
          <motion.p
            layoutId={layout ? `title-${card.title}` : undefined}
            className="text-white text-xl md:text-3xl font-semibold max-w-xs text-left [text-wrap:balance] mt-2 group-hover:text-blue-200 transition"
          >
            {card.title}
          </motion.p>
        </div>
